...
export default function AuthForm({ title, buttonText, error, children, footerLink }: AuthFormProps) {
  return (
    <div className="w-full max-w-sm mx-auto bg-white p-8 rounded-xl shadow-2xl">
      ...
      {/* Le formulaire lui-même est maintenant à l'extérieur, pour passer la Server Action */}
      <>
